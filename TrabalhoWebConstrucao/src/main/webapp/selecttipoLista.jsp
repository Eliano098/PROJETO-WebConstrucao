...
<div class="card">
  <div class="card-header">
   <h1 class="col-md-10 offset-md-5">Tipo de Projetos
	...
	<div class="card" style="width: 27rem;">
	 	<img class="col mx-auto text-center card-img-top w-50 p-3 h-50 d-inline-block" src="https://cdn-icons.flaticon.com/png/512/2243/premium/2243652.png?token=exp=1638042274~hmac=8ef8261bc69b65e3c2045317d25c980e" alt="Imagem de capa do card">
      	<div class="card-body">
	        ...
	        <p class="card-text">Projetos Residenciais</p>
    			<%if(!request.getParameter("id").equals("X")){ %>
    				<a href="projetoscon.jsp?Tipo=0&id=<%=request.getParameter("id")%>" class="btn btn-primary">Listar</a>
    			<%}else{%> 
    				<a href="projetoscon.jsp?Tipo=0&id=X" class="btn btn-primary">Listar</a>
     			<%} %>
 	   </div>
    </div>
</div>
	...
	<div class="card" style="width: 27rem;">
	 	<img class="col mx-auto text-center card-img-top w-50 p-3 h-50 d-inline-block" src="https://cdn-icons.flaticon.com/png/512/3524/premium/3524890.png?token=exp=1638042257~hmac=e470dee717f7c27f9afcf4072c4acd75" alt="Imagem de capa do card">
      	<div class="card-body">
	        ...
	        <p class="card-text">Projetos Comerciais</p>
				 <%if(!request.getParameter("id").equals("X")){ %>
    				<a href="projetoscon.jsp?Tipo=1&id=<%=request.getParameter("id")%>" class="btn btn-primary">Listar</a>
    			<%}else{%> 
    				<a href="projetoscon.jsp?Tipo=1&id=X" class="btn btn-primary">Listar</a>
     			<%} %> 
       </div>
    </div>
</div>
	...
	<div class="card" style="width: 27rem;">
	 	<img class="col mx-auto text-center card-img-top w-50 p-3 h-50 d-inline-block" src="https://cdn-icons.flaticon.com/png/512/3524/premium/3524787.png?token=exp=1638042128~hmac=eb911289b4349cfd3a58ad5b6679c918" alt="Imagem de capa do card">
      	<div class="card-body">
	        ...
	        <p class="card-text">Projetos de Edifícios</p>
				<%if(!request.getParameter("id").equals("X")){ %>
    				<a href="projetoscon.jsp?Tipo=2&id=<%=request.getParameter("id")%>" class="btn btn-primary">Listar</a>
    			<%}else{%> 
    				<a href="projetoscon.jsp?Tipo=2&id=X" class="btn btn-primary">Listar</a>
     			<%} %>  
     	</div>
   </div>
